...
function About() {
  ...
  return (
    <div className='container mx-auto my-12 p-4 space-y-9'>
      ...
      <p>
        this is {""}
        <strong className='text-blue-800 font-semibold hover:scale-105 duration-500'>{profile?.user?.user?.name}</strong>{''}
      ...
      <h2 className='font-semibold text-blue-800 text-xl'>Technical Experties:</h2>
      <p>
